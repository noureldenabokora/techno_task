        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Gaps.vGap12,
              Text(
                "Are you wanna delete your account address",
                style: TextStyle(
                    color: Colors.grey[600], fontSize: 13.sp, height: 1.8.h,fontWeight: FontWeight.bold),
              ),
              Gaps.vGap(30),
              CustomTextButton(text: "Delete", function: (){AppNavigator(context, true, RegisterView());}, color: Color(0xffED1C24), width: double.infinity),
              Gaps.vGap12,
              Container(
